                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <a href="{{ route('moderation.achievements.index') }}" class="btn btn-outline-warning btn-sm">
                                    <i class="bi bi-trophy me-1"></i>Управление наградами
                                </a>
                                @if(auth()->user()->isAdmin())
                                <a href="{{ route('moderation.emojis.index') }}" class="btn btn-outline-info btn-sm">
                                    <i class="bi bi-emoji-smile me-1"></i>Управление смайликами
                                </a>
                                @endif
                            </div>
                        </div>
